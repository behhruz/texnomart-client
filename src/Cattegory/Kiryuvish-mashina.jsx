...
const Kiryuvishmashinasi = () => {
  ...
  const xiaomiProducts = products.filter(product => product.cattegory === '');
    ...
    <>
      ...
      <div className="flex gap-6 flex-wrap justify-center items-center my-10">
        ...
        {xiaomiProducts.length > 0 ? (
          ...
          <p>Kiryuvish-mashinasi mahsulotlari topilmadi.</p>
        )}
      </div>
      <Footer />
    </>
...
export default Kiryuvishmashinasi;
