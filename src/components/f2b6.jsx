    ...
    fetch('http://localhost:5000/Products')
      ...
      .then(data => {
        ...
        if (Array.isArray(data)) {
          const filteredProducts = data.filter(product => product.brand === 'Vivo');
          console.log('Filtered Vivo products:', filteredProducts); // Log filtered products
    ...
    <div className="products-container">
      ...
      <div className="products-grid">
        {products.length > 0 ? (
          ...
          <p>No Vivo products available.</p>
        )}
      </div>
    </div>
  );
