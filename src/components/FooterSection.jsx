        ...
        <div className=''>
            <div className="max-w-screen-xl mx-auto py-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <Link to="/free-delivery" className="flex flex-col items-center justify-center p-4 text-center bg-white shadow-lg rounded-lg">
                    ...
                    <Link to="/product-warranty" className="flex flex-col items-center justify-center p-4 text-center bg-white shadow-lg rounded-lg">
                    ...
                    <Link to="/bonus-system" className="flex flex-col items-center justify-center p-4 text-center bg-white shadow-lg rounded-lg">
                    ...
                    <Link to="/help" className="flex flex-col items-center justify-center p-4 text-center bg-white shadow-lg rounded-lg">
