...
const Hometech = () => {
  ...
  const category = 'Hometech'; // Desired category name
        ...
        {products.length > 0 ? (
          products.map((product, index) => (
            <div key={index} className="product-card">
              {product.discount && (
                <div className="discount-timer">{product.discount}</div>
              )}
              <img
              ...
              <div className="monthly-cost-container">
                <p className="monthly-cost">{product.costMonth1}</p>
                {product.costMonth2 && (
                  <p className="monthly-cost cost-month-2">
                    {product.costMonth2}
                  </p>
                )}
              </div>
              <p className="product-cost">
                ...
                {product.oldCost && (
                  <span className="product-old-price"> {product.oldCost}</span>
                )}
              </p>
